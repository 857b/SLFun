...
Definition spec_0 : FDecl (ptr * ptr) _ unit _
  ...
  '_ tt [vptr p0 ~> n1; vptr p1 ~> n0] True.
...
Definition spec_2 : FDecl (ptr * ptr * ptr) _ ptr _
  SPEC (p0, p1, p2)
  '(n0, n1, n2) [vptr p2 ~> n2] [vptr p0 ~> n0; vptr p1 ~> n1] True
  'p (n, n1') [vptr p ~> n; vptr p1 ~> n1'] (n1' > 0).
Proof. Derived. Defined.
...
Definition spec_3 : FDecl ptr (Some (fun _ => ptr)) ptr (Some (fun _ => ptr))
  SPEC p0 & p1
  '(n0, n1) [] [vptr p0 ~> n0; vptr p1 ~> n1] True
  'p0' & p1' (n0', n1') [vptr p0' ~> n0'; vptr p1' ~> n1'] True.
Proof. Derived. Defined.
...
Definition elim_cell2_spec : LDecl ptr unit
  SPEC p 'n01 [] [cell2 p ~> n01] True
  '_ tt [vptr p ~> (fst n01); vptr (S p) ~> (snd n01)] True.
Proof. Derived. Defined.
...
Definition intro_cell2_spec : LDecl ptr unit
  SPEC p '(n0, n1) [] [vptr p ~> n0; vptr (S p) ~> n1] True
  '_ tt [cell2 p ~> (n0, n1)] True.
Proof. Derived. Defined.
...
Definition spec_5 : FDecl ptr _ unit _
  ...
  '_ v' [cell2 p ~> v'] (v' = let (n0, n1) := v in (S n0, n1)).
Proof. Derived. Defined.
...
Definition spec_a1a : FSpec sigh_a1a
  ...
  '_ (n1', n2') [vptr p1 ~> n1'; vptr p2 ~> n2'] (b = true -> n1' = 0).
Proof. Tac.build_FSpec. Defined.
